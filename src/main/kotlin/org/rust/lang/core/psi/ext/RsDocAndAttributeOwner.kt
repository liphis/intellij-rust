...
inline val RsDocAndAttributeOwner.docAndAttrStub: RsDocAndAttributeOwnerStub?
...
private fun RsDocAndAttributeOwner.evaluateCfg(): ThreeValuedLogic {
    ...
    if (docAndAttrStub?.hasCfg == false) return ThreeValuedLogic.True
